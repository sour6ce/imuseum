    ...
    <P className="relative " as='div'>
      {({ open,close }:{open:boolean,close:()=>void}) => (
        <>
          ...
          >
            <P.Panel as='div' className={`absolute z-40 ${props.position === 'left' ? 'left-0' : 'right-0'} z-50 bg-white mt-1 w-screen shadow-xl ring-2 ring-gray-950 ring-opacity-5 rounded-lg max-w-md px-4 sm:px-0`}>
